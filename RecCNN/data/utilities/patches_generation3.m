function [inputs, labels, set] = patches_generation3(JPEG_Quality,size_input,size_label,stride,folder,mode,max_numPatches,batchSize)
...
load(fullfile('model_QP_30','measurements-2-quality-80','model_QP_30-epoch-43.mat'));
