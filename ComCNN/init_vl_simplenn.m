function res = init_vl_simplenn(net,net1, x, dzdy, res, imdb, batchStart, varargin)
...
for i=1:n
  ...
  switch l.type
    ...
    case 'loss'
      [res(i+1).x,diff] = vl_nnloss(res(i).x, l.class, net1) ;
...
if doder
  ...
  for i=n:-1:backPropLim
    ...
    switch l.type
      ...
      case 'loss'
        [res(i).dzdx,~] = vl_nnloss(res(i).x, l.class, net1, res(i+1).dzdx,diff) ;
